...
<body>
    <div class="container " style="display: flex; justify-content: center; align-items: center; height: 100vh">
        <div class="container">
            ...
            ?>
            <form action="controller/logarUser.php" method="POST" class="login">
                ...
                <div class="form-group">
                    <div class=" mt-2 col-md-6 offset-md-3">
                        <input type="submit" value="Login" class="col-12 shadow-sm btn btn-primary bg-gradient" name="" style="display: block; justify-content: center; align-items: center; width: 100%">
                    </div>
                </div>
            </form>
        </div>
